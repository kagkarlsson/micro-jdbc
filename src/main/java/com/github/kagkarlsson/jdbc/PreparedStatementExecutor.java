...
public interface PreparedStatementExecutor<T> {
	...
	PreparedStatementExecutor<Boolean> EXECUTE = new PreparedStatementExecutor<Boolean>() {
		@Override
	...
	PreparedStatementExecutor<int[]> EXECUTE_BATCH = new PreparedStatementExecutor<int[]>() {
		@Override
